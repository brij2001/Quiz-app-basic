                ...
                <table class="auto-style1">
                    <tr>
                        <td colspan="2" style="text-align: center; vertical-align: top">
                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="Student Log In "></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <asp:LinkButton class="positioning btn btn-secondary" ID="LinkButton1" runat="server" PostBackUrl="adminLogin.aspx">Admin Login</asp:LinkButton></td>
                        <td style="text-align: center" class="auto-style4">
