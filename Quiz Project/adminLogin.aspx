...
<body>
    <form id="form1" runat="server">
        ...
        <center>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:LinkButton class="btn btn-primary btn-sm" ID="insert" runat="server" CommandName="insert">Insert</asp:LinkButton>
                         </td>
                        <td>
            ...
            <br />
            <br />
            <asp:LinkButton class="positioning btn btn-secondary" ID="LinkButton1" runat="server" PostBackUrl="studentLogin.aspx">Student Login</asp:LinkButton>
        </center>
    </form>
</body>
</html>
